...
public class Router6 {
	...
	public Router6(int routerPort) {
		this.routerPort = routerPort;
	}
	
	public Router6(int routerPort, boolean routerOn, boolean allowDrop, int droppingProbability) {
		this.routerPort = routerPort;
	...
	public Router6(int routerPort, boolean routerOn) {
		this.routerPort = routerPort;
		this.routerOn = routerOn;
	}
...
//						System.out.println("Ramdom No : "+randomNum);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Router6 router1 = new Router6(Integer.parseInt(ConfigUtil

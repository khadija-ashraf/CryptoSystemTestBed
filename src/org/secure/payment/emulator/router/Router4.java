...
public class Router4 {
	...
	public Router4(int routerPort) {
		this.routerPort = routerPort;
	}
	
	public Router4(int routerPort, boolean routerOn, boolean allowDrop, int droppingProbability) {
		this.routerPort = routerPort;
	...
	public Router4(int routerPort, boolean routerOn) {
		this.routerPort = routerPort;
		this.routerOn = routerOn;
	}
...
//						System.out.println("Ramdom No : "+randomNum);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Router4 router1 = new Router4(Integer.parseInt(ConfigUtil

...
public class Router5 {
	...
	public Router5(int routerPort) {
		this.routerPort = routerPort;
	}
	
	public Router5(int routerPort, boolean routerOn, boolean allowDrop, int droppingProbability) {
		this.routerPort = routerPort;
	...
	public Router5(int routerPort, boolean routerOn) {
		this.routerPort = routerPort;
		this.routerOn = routerOn;
	}
...
//						System.out.println("Ramdom No : "+randomNum);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Router5 router1 = new Router5(Integer.parseInt(ConfigUtil

...
public class Router2 {
	...
	public Router2(int routerPort) {
		this.routerPort = routerPort;
	}
	
	public Router2(int routerPort, boolean routerOn, boolean allowDrop, int droppingProbability) {
		this.routerPort = routerPort;
	...
	public Router2(int routerPort, boolean routerOn) {
		this.routerPort = routerPort;
		this.routerOn = routerOn;
	}
...
//						System.out.println("Ramdom No : "+randomNum);
	...
	public static void main(String[] args) {
		...
		try {
			...
			Router2 router1 = new Router2(Integer.parseInt(ConfigUtil

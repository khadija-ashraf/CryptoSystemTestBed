...
public class Router {
	...
	public Router(int routerPort) {
		this.routerPort = routerPort;
	}
	
	public Router(int routerPort, boolean routerOn, boolean allowDrop, int droppingProbability) {
		this.routerPort = routerPort;
	...
	public Router(int routerPort, boolean routerOn) {
		this.routerPort = routerPort;
		this.routerOn = routerOn;
	}
